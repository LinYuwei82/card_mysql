...
# 注册字体
harmonysansB = "HarmonySansB"
harmonysansR = "HarmonySansR"

pdfmetrics.registerFont(TTFont(harmonysansB, (os.path.join(BASE_DIR, "resources/fonts/OPPOSans-B.ttf"))))
pdfmetrics.registerFont(TTFont(harmonysansR, (os.path.join(BASE_DIR, "resources/fonts/OPPOSans-R.ttf"))))
...
class CardModel:
    ...
    def card_model_print(self):
        ...
        textobject1.setFont(harmonysansB, 11)
        ...
        textobject2.setFont(harmonysansB, 15)
        ...
        textobject3.setFont(harmonysansR, 11)
        ...
        textobject4.setFont(harmonysansR, 11)
        ...
        textobject5.setFont(harmonysansR, 11)
        ...
        textobject6.setFont(harmonysansR, 11)
...
class CardData:
    ...
    def card_data_print(self, dev_name, location, control_range, phone):
        ...
        textobject2.setFont(harmonysansB, 11)
        ...
        textobject3.setFont(harmonysansB, 11)
        ...
        textobject4.setFont(harmonysansB, 11)
        textobject4.setHorizScale(90)
        textobject4.setCharSpace(0.9)
        textobject4.setFillColorCMYK(0, 0, 0, 1)
        new_phone = phone[:3] + " " + phone[3:7] + " " + phone[7:]  # 格式化电话号码，先显示前3个，再分别显示后4个
            ...
            for i in range(4):  # 从上到下
                for j in range(3):  # 从左到右
                    if k < row:
                        ...
                        k += 1
                        # print(k)
                        if k % 12 == 0 and k < row:  # 没有打完,并每满12组换下一页,避免出现空白页面
                            c1.showPage()
